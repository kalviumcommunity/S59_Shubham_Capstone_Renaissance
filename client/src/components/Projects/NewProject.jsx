    ...
    return (
        <div className='flex h-fit'>
            <form className="w-[50vw] py-10 px-12 bg-white"
                ...
                <hr className="my-1.5" />
                <p className="text-sm text-gray-700 mt-1.5">(*) are required</p>
                <div className="flex w-fit mt-10">
                    <div className="mr-5">
                        <p className="font-bold">Owner*</p>
                        <div className="flex">
                            <p className="text-sm border border-1.5 bg-[#D6E7DA] border-[#3F5F4F] px-2 py-1.5 rounded">Shubhh_Thakur /</p>
                        </div>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <div className="flex">
                        <select className='text-sm bg-gray-300 rounded mt-1.5 px-2 py-1.5' onChange={(e) => setSelectedTags(prevTags => ([
                            ...prevTags,
                            e.target.value
                        ]))}>
                ...
                <div>
                    <div className='flex items-center m-3'>
                        ...
                        <div className='ml-3'>
                            ...
                            <p className="text-[12px] text-gray-700">Anyone on internet can see, visit and contribute to your project. See more here.</p>
                        </div>
                    </div>
                    <div className='flex items-center m-3'>
                        ...
                        <div className='ml-3'>
                            ...
                            <p className="text-[12px] text-gray-700 ">Anyone on internet can see and visit but would require permission to contribute. See more here.</p>
                        </div>
                    </div>
                </div>
                <hr className="my-5" />
            ...
            <div className="w-[50vw] bg-cover fixed  right-0 top-0 h-full" style={{ backgroundImage: `url(https://c1.wallpaperflare.com/preview/895/605/304/photo-beethoven-composer-germany.jpg)` }}>
                <div className='absolute bottom-[20px] left-[10px] py-1.5 px-3 bg-white bg-opacity-60 text-slate-900 rounded'>
                    ...
                    <p className='text-[12px] w-[300px]'>He is one of the most revered figures in the history of Western music; his works rank among the most performed of the classical music repertoire.</p>
                </div>
            </div>
        </div >
    )
