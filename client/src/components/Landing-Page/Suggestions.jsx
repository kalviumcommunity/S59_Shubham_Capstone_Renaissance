...
function Suggestions({ title, author, desc, img, direction }) {
    return (
        <div className={`h-[400px] bg-cover relative mt-8 flex items-center justify-center px-12 ${direction === 'left' ? 'flex-row-reverse' : null}`} style={{ backgroundImage: `url(${bgSemiGreen})` }}>
