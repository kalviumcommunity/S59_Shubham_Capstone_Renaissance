...
function MyProfile({ userID, setLogin, isLogin }) {
    ...
    return (
        userData ?
            <form className='py-10 px-8 bg-gray-100 rounded border border-gray-300 mt-10'
                ...
                <div className='flex justify-between items-center mb-3'>
                    ...
                    {isLogin ? null : <button type='button' className="bg-red-200 ml-1.5 text-sm border border-red-500 mr-5 rounded py-1.5 px-5" title="Logout" onClick={() => logoutUtil(setLogin)}>Logout</button>}
                </div>
                ...
                <div className="white shadow rounded py-10 px-8 bg-white my-5">
                    ...
                    <div className='flex justify-start items-start'>
                        <div className='flex flex-col items-center justify-center'>
                            ...
                            <button type="button" className="bg-[#97D4A6] m-auto mt-3 text-[13px] border-solid border-[#97D4A6] rounded border-2 py-1.5 px-3" onClick={handleFileUpload}>Change</button>
                        </div>
                        <div className='flex flex-col justify-center ml-8 mt-5'>
                            <div>
                                ...
                                <input
                                    type="text"
                                    className='text-sm text-left border border-1.5 bg-gray-100 border-gray-300 rounded py-1.5 px-3 text-gray-600'
                            ...
                            <div>
                                ...
                                <textarea rows={4} cols={50} className='text-sm text-left border border-1.5 bg-gray-100 border-gray-300 rounded py-1.5 px-3 text-gray-600'
                ...
                <div className="white shadow rounded py-10 px-8 bg-white my-5">
                    ...
                    <div>
                        <p className='text-[13px] text-gray-400 pl-3 mt-5'>Your Contact Number:</p>
                        <input
                            type="text"
                            className='text-sm text-left border border-1.5 bg-gray-100 border-gray-300 rounded py-1.5 px-3 text-gray-600'
                        ...
                        {errors.phNumber && <p className='text-sm m-0.5 text-red-500'>{errors.phNumber.message}</p>}
                    </div>
                    <div>
                ...
                <button type='submit' className="bg-[#97D4A6] ml-1.5 text-sm border-solid border-[#97D4A6] mr-5 rounded border-2 py-1.5 px-3" >Save Changes</button>
            </form>
            :
            < Loader />
    )
